...
import {forwardRef, useCallback, useEffect, useMemo, useState,} from '@googleforcreators/react';
import styled from 'styled-components';
import {getExtensionsFromMimeType} from '@googleforcreators/media';
import {__, sprintf, translateToExclusiveList,} from '@googleforcreators/i18n';
import {DatalistDropdown, DatalistOption, Icons, Link, Text, TextSize,} from '@googleforcreators/design-system';
import {
...
function PublishPanel({nameOverride}) {
    ...
    const {
        ...
        apiCallbacks: {getPublisherLogos, addPublisherLogo},
    } = useConfig();
