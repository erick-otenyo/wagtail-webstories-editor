 ...
 */
import settingsReducer, {ACTION_TYPES as SETTINGS_ACTION_TYPES, defaultSettingsState,} from '../reducers/settings';
...
export default function useSettingsApi() {
    ...
    const {
        ...
        apiCallbacks: {fetchSettings: fetchSettingsCallback, updateSettings: updateSettingsCallback}
    } = useConfig();
